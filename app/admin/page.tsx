    ...
    <div className="min-h-screen bg-base-100">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Users Card */}
          <Link href="/admin/users" className="card bg-base-200 shadow-lg hover:shadow-xl transition-shadow">
            <div className="card-body">
              ...
              <p>View and manage all users, their plans, and protocol access.</p>
              <div className="card-actions justify-end mt-4">
                <div className="badge badge-primary">Users</div>
                <div className="badge badge-primary">Protocols</div>
              </div>
            </div>
          </Link>
