      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
        ...
        <div className="flex flex-col items-center justify-center gap-3 mb-6 sm:mb-8 max-w-md mx-auto">
          ...
          <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"></path></svg>
            ...
            <span className="font-medium font-mono text-sm whitespace-nowrap">Custom content pillars</span>
            </div>
            <div className="flex items-center gap-2 bg-base-100 px-4 py-2 rounded-lg shadow-md border border-base-content/10 w-full sm:w-auto min-w-[220px] justify-center">
            <div className="rounded-full p-1 bg-primary/20 text-primary">
            <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"></path></svg>
            </div>
            <span className="font-medium font-mono text-sm whitespace-nowrap">Weekly content calendar</span>
            </div>
            <div className="flex items-center gap-2 bg-base-100 px-4 py-2 rounded-lg shadow-md border border-base-content/10 w-full sm:w-auto min-w-[220px] justify-center">
            <div className="rounded-full p-1 bg-primary/20 text-primary">
            <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"></path></svg>
            </div>
            <span className="font-medium font-mono text-sm whitespace-nowrap">Ready-to-use prompts</span>
          </div>
        </div>
